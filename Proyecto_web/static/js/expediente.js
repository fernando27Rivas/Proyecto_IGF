...
$.fn.pageMe = function(opts) {
  ...
  if (settings.showFirstLast) {
    $('<li><a href="#" class="first_link">Primero</a></li>').appendTo(pager);
  }
  ...
  if (settings.showFirstLast) {
    $('<li><a href="#" class="last_link">Último</a></li>').appendTo(pager);
  }
...
$(document).ready(function(){
  ...
  $('#accordion').pageMe({pagerSelector:'#myPager',childSelector:'.paginable',showPrevNext:true,hidePageNumbers:false,perPage:4});

});

(function () { $(document).on('click', '.panel-heading span.clickable', function(e){
    var $this = $(this);
